...
public class RequestGetServlet extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		 ...
		 * */
	    String name = request.getParameter("name"); // "민경민", ""(텍스트 상자가 빈경우 빈 문자열이 넘어간다)
         ...
         * 
         * 장점 : Java코드내에 작성하기 때문에 반복문, 조건문등 유용한 메소드 활용이 가능하다
         * 
         * 단점 : 진짜 복잡하다, 혹시라도 추후 html을 수정하고자 한다면 Java소스코드 내에서 수정이 이루어지기떄문에
